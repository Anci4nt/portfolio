...
<ul className="flex space-x-5">
  {["/home", "/skills", "/journey", "/projects"].map((item, index) => (
    <li
      key={item}
      className={`hover:text-green-500 relative group transition-all duration-200 ease-in-out animate-fade-in opacity-0 animation-delay-${index * 100}`}
      style={{ animation: `fadeIn 0.3s ease-in-out forwards`, animationDelay: `${index * 100}ms` }}
    >
      <a href="#" className="transition-transform duration-200 group-hover:scale-105">
        {item}
            ...
            <div className="flex flex-col sm:flex-row mt-10">
              <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                ...
                <div className="flex flex-col items-center text-center justify-center">
                  ...
                  <p className="text-base">Frontend Development<br />🕸<br />Video Editor</p>
                </div>
              </div>
              <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                <p className="leading-relaxed text-lg mb-4">
                  A 14 year old doing competitive programming and frontend web development. I've been doing coding for the past 4 years and web development for 3.5 years.
                  <br />Welcome to my portfolio!! Here you will find everything about me and what I've done in my professional life.
                </p>
              </div>
            </div>
          </div>
